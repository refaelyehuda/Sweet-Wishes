package com.menachi.class3demo.DateAndPickers.Date;
...
public class DateEditText extends EditText {
    ...
    private void init(){
        ...
        //the month begin from 0 zero in android because this we increment the month with 1
    ...
    public boolean onTouchEvent(MotionEvent event) {
        //check if the edit text is touched
